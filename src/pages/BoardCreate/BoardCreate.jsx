...
export default function BoardCreate() {
  ...
  const logState = (id, state) => {
    ...
    if (state === false) {
      const existBtn = choosenBtn.find((btn) => btn.id === id);
      console.log(existBtn);

      if (existBtn) {
        const filterdArray = choosenBtn.filter((btn) => btn.id !== existBtn.id);

        console.log(filterdArray);

        setChoosenBtn(filterdArray);

        const lastnOfChoosenBtnArray = choosenBtn[choosenBtn.length - 2].id;
        setCurrentDesc(
          ColSelBtn.find((btn) => btn.id === lastnOfChoosenBtnArray).desc
        );
      }
    } else if (state === true) {
      setCurrentDesc(ColSelBtn.find((btn) => btn.id === id).desc);

      setChoosenBtn([...choosenBtn, { id }]);
    }
  };
              ...
              <div className="md:px-32 md:py-16 flex flex-col md:justify-start justify-start items-center ">
                <div className="flex flex-col  w-[80%] md:w-full h-full justify-center">
                  ...
                  <div className="flex  flex-col justify-center items-start mt-3 text-sm sm:text-base">
                    ...
                    {
                      <div
                        className={`  box-content flex items-center	 bg-allgrey-background-color lg:my-12 my-8 ps-3 lg:pe-16 py-3 pe-5  lg:h-14 h-10 ${
                    ...
                    <div className="w-full lg:mt-5 flex flex-auto ">
